...
All graphic elements were created by me in Photoshop.<br/> 
I started with the design, then cut each image individually before implementing them in the game.<br/>
The electrocardiogram is animated using After Effects.

The project also includes a rather simple infection system.<br/> 
When a player is hit by a zombie, their infection percentage increases, and if it reaches 100%, the player transforms into a zombie.
...
Each player can carry only a limited number of weapons, ammo, and items combined.<br/>
Each item is displayed in a window triggered by a button, and can be equipped, used, combined, or dropped.<br/>
...
This part of the project taught me a lot about client-server interaction.<br/>
For example, to display a player’s inventory contents or possible combinations, I implemented a client function that requests the necessary information from the server.
...
### Ongoing Addon Updates

{{gallery:3}}

I continuously improve my addon by fixing bugs and regularly adding new features, including:

*	An animated pickup history displayed on the HUD
*	Item trading between players
*	An item details window with a 3D preview
*	A flashlight battery system
*	New items and crafting combinations
*	And much more…
